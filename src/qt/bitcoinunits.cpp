...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SMARTIE);
    unitlist.append(mSMARTIE);
    unitlist.append(uSMARTIE);
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case SMARTIE:  return 100000000;
    case mSMARTIE: return 100000;
    case uSMARTIE: return 100;
    case veffs: return 1;
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case SMARTIE: return 8;
    case mSMARTIE: return 5;
    case uSMARTIE: return 2;
    case veffs: return 0;
    default: return 0;
    }
}
